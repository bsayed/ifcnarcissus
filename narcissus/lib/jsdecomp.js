...
define(['./n', './jsdefs', './jslex','./jsparse'], function(Narcissus, definitions, lexer, parser) {
            ...
            switch (n.type) {
                ...
                case CONST:
                    ...
                    for (var i = 0, j = nc.length; i < j; i++) {
                        ...
                        var u = nc[i];
                        if (u.type === ASSIGN) {
                            p += pp(u.children[0],d) + " = " + pp(u.children[1], d);
                            continue;
                        }
                        // Some changes have been made in jsparse.js that
                        // haven't been reflected here
                        // if node type is identifier use u.value
